...
[here](https://github.com/oganm/5eInteractiveSheet/raw/master/sheet/RInno_installer/setup_5eInteractiveSheet.exe), install and run. After that you
should be golden.
...
If you are on windows, uninstall your previous version, download exe and install 
again. Other's just run
